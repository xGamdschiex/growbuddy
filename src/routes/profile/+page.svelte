<script lang="ts">
	...
	let googleLoginBusy = $state(false);
	async function loginGoogle() {
		...
		// Lock bewusst halten bis Custom-Tab/User zurückkommt; reset nach 5s falls nichts passiert
		setTimeout(() => { googleLoginBusy = false; }, 5000);
	}
